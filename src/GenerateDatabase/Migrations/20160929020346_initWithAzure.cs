...
{
    public partial class initWithAzure : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Burgh = table.Column<string>(maxLength: 120, nullable: false),
                    DtLastUpdate = table.Column<DateTimeOffset>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentNumber = table.Column<string>(maxLength: 13, nullable: false),
                    DtLastUpdate = table.Column<DateTimeOffset>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastOrderAmout = table.Column<decimal>(nullable: false),
                    Status = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockProduct", x => new { x.StockId, x.ProductId });
                    table.ForeignKey(
